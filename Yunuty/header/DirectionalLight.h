...
{
	class YunutyCycle;
	class YUNUTY_API DirectionalLight :public Renderable<yunuGI::IDirectionalLight>
	{
	protected:
	public:
		// GI는 Graphics Interface라는 뜻임.
		yunuGI::IDirectionalLight& GetGI() { return Renderable<yunuGI::IDirectionalLight>::GetGI(); }
		DirectionalLight();
	};
}
