...
{
    qDamageComponent->SetSkillDamage(application::GlobalConstant::GetSingletonInstance().pod.hanselQSkillStompDamage);
    qDamageCollider->SetRadius(application::GlobalConstant::GetSingletonInstance().pod.hanselQSkillStompRadius);
    isQSkillReady = false;
