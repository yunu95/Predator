...
namespace application
{
    ...
    void CinematicManager::SetCinematicMode(bool isCinematicMode)
    {
        if (!this->isCinematicMode && isCinematicMode)
        {
            ...
            PlayerController::Instance().SetStateInAction(PlayerController::State::Cinematic,true);
        }
        else if (this->isCinematicMode && !isCinematicMode)
        {
            ...
            PlayerController::Instance().SetStateInAction(PlayerController::State::Cinematic,false);
        }
    }
}
