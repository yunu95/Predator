	...
	namespace editor
	{
		...
		namespace palette
		{
			...
			public:
				...
				/// <summary>
				/// Play / Editor 모드 전환 시에 Instance 를 활성화하기 위한 함수입니다.
				/// 기본적으로 해당 GameObject 의 Active 를 true 처리하지만,
				/// 필요에 따라 다른 동작으로 설계할 수 있습니다.
				/// </summary>
				virtual void ShowEditorInstance();

				/// <summary>
				/// Play / Editor 모드 전환 시에 Instance 를 숨기기 위한 함수입니다.
				/// 기본적으로 해당 GameObject 의 Active 를 False 처리하지만,
				/// 필요에 따라 다른 동작으로 설계할 수 있습니다.
				/// </summary>
				virtual void HideEditorInstance();
