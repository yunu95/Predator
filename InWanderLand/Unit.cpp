...
std::shared_ptr<PauseReference> Unit::AcquirePauseReference()
{
    return std::shared_ptr<PauseReference>();
}
...
void Unit::PlayAnimation(AnimType animType)
{
}
...
void Unit::ApplyKnockback()
{
}

void Unit::ApplyParalysis()
{
}
...
const editor::Unit_TemplateData& Unit::GetUnitTemplateData()
{
