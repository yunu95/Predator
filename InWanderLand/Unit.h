...
public:
    ...
    void SetIdleAnimation(yunuGI::IAnimation* idleAnim);
    void SetWalkAnimation(yunuGI::IAnimation* walkAnim);
    void SetAttackAnimation(yunuGI::IAnimation* attackAnim);
    void SetDeathAnimation(yunuGI::IAnimation* deathAnim);
