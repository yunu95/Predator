...
namespace application
{
	namespace editor
	{
		std::vector<std::string> Interactable_TemplateData::interactableFBXNameList = { "Trigger_Cube", "Trigger_Sphere", "SM_Chess_Bishop", "SM_Chess_Pawn", "SM_Chess_Rook", 
			"SM_Spike01", "SM_Spike02", "SM_Spike03", "SM_Gimmick01", "SM_Gimmick02" };
