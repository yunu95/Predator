...
#pragma endregion
    ...
    {
        if (each->GetName() == L"Rig_Robin|Ani_Hansel_Idle")
        {
        ...
        else if (each->GetName() == L"Rig_Robin|Ani_Hansel_Walk")
        {
        ...
        else if (each->GetName() == L"Rig_Robin|Ani_Hansel_Attack")
        {
            m_baseUnitAnimations.m_attackAnimation = each;
            m_baseUnitAnimations.m_attackAnimation->SetLoop(false);
        }
        else if (each->GetName() == L"Rig_Robin|Ani_Hansel_APose")
        {
        ...
        else if (each->GetName() == L"Rig_Robin|Ani_Hansel_Death")
        {
        ...
        /// Skill Animation
        else if (each->GetName() == L"Rig_Robin|Ani_Hansel_Skill1")
        {
            each->SetLoop(false);
        ...
        else if (each->GetName() == L"Rig_Robin|Ani_Hansel_Skill2")
        {
            each->SetLoop(true);
            animator->PushAnimation(each);
        ...
        else if (each->GetName() == L"Rig_Robin|Ani_Hansel_Live")
        {
