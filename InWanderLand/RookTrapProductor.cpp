...
//
//void RookTrapProductor::SetUnitData()
//{
//	m_objectName = "RookTrap";
...
//}
//
//void RookTrapProductor::SingletonInitializer()
//{
//	SetUnitData();
//}
//
//Unit* RookTrapProductor::CreateUnit(Vector3d startPos)
//{
//#pragma region Animation Related Member Setting
//	m_unitGameObject = yunutyEngine::Scene::getCurrentScene()->AddGameObjectFromFBX("SM_Chess_Rook");
...
//
//	chessSkillSystem->SetChessType(ChessTrapSkillSystem::ChessPieceType::Rook);
