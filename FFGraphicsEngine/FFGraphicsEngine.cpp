...
LazyObjects<FFGraphicsEngine> FFGraphicsEngine::Instance;
...
{
    CameraManager::GetInstance().GetCamera(0)->SetResolution(p_width, p_height);
}
...
void FFGraphicsEngine::LoadFBX(const std::wstring& p_path)
{
    ResourceManager::GetInstance()->LoadFBX(p_path);
}
