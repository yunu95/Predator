...
#pragma comment(lib,"FFlibfbxsdk-md.lib")
#pragma comment(lib,"FFlibxml2-md.lib")
#pragma comment(lib,"FFzlib-md.lib")
//#ifdef _DEBUG
...
struct MATERIAL_DESC
{
    ...
    bool operator==(MATERIAL_DESC& rhs)
    {
        ...
        if ((this->materialName == rhs.materialName)
            ...
            && (std::ranges::equal(this->texture, rhs.texture))
            && (std::ranges::equal(this->intParams, rhs.intParams))
            && (std::ranges::equal(this->floatParams, rhs.floatParams))
            && (std::ranges::equal(this->vec2Params, rhs.vec2Params))
            && (std::ranges::equal(this->vec4Params, rhs.vec4Params))
            /*&& (std::equal(begin(this->texture), end(this->texture), begin(rhs.texture), end(rhs.texture)))
            && (std::equal(begin(this->intParams), end(this->intParams), begin(rhs.intParams), end(rhs.intParams)))
            && (std::equal(begin(this->floatParams), end(this->floatParams), begin(rhs.floatParams), end(rhs.floatParams)))
            && (std::equal(begin(this->vec2Params), end(this->vec2Params), begin(rhs.vec2Params), end(rhs.vec2Params)))
            && (std::equal(begin(this->vec4Params), end(this->vec4Params), begin(rhs.vec4Params), end(rhs.vec4Params)))*/
            && (this->color == rhs.color))
        {
            return true;
        }
