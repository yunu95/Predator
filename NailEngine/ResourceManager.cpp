...
//	);
    ...
    CreateTexture(L"PointLightShadowDepth", 1024, 1024, DXGI_FORMAT_R24G8_TYPELESS, static_cast<D3D11_BIND_FLAG>(D3D11_BIND_DEPTH_STENCIL | D3D11_BIND_SHADER_RESOURCE),6);
}
