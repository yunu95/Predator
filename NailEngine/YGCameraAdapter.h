...
namespace yunuGIAdapter
{
	...
	public:
		...
		{
			DirectX::SimpleMath::Vector4 dxWorldPos{ worldPos.x, worldPos.y, worldPos.z, 1 };
			auto tempVec =  DirectX::SimpleMath::Vector4::Transform(dxWorldPos, CameraManager::Instance.Get().GetCamearaList().at(this)->GetVTM());
			return reinterpret_cast<yunuGI::Vector3&>(tempVec);
		}
